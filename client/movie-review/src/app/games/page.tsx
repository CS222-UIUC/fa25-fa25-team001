...
import { getTrendingGameReviews } from '@/actions/media';
...
export default function GamesPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await getTrendingGameReviews(5);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-12">
          ...
          {trendingReviews.length > 0 ? (
            ...
            <div className="text-center py-12 glass-strong rounded-2xl">
              <p className="text-sky-700 text-lg font-medium">No reviews yet. Be the first to review a game!</p>
            </div>
          )}
        </div>
      </div>
